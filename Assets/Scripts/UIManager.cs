...
public class UIManager : MonoBehaviour {
    ...
    {
        float ratio_0 = (10 - GameManager.instance.mana[0]) / maxMana;
        ...
        manaLeft.rectTransform.anchoredPosition = new Vector2(maxWidth/2 * (-1 + ratio_0), manaLeft.rectTransform.anchoredPosition.y);
